...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/form.css" />
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/res/jquery-ui/css/ui-lightness/jquery-ui-1.10.3.custom.min.css"/>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/res/css/common.css"/>
...
<body>
        <div id="page-wrap">
            <div id="header">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/res/img/banner.jpg">
	    </div>
...
<div class="container" id="page">
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Kelompok 4 Kelas Mandiri 5SI-R 2010 STMIK Indonesia.<br/>
