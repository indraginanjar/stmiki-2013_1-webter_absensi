...
class HariController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Hari');
	...
	{
		$model=new Hari('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hari']))
			$model->attributes=$_GET['Hari'];
	 ...
	 * @param Hari $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hari-form')
		{
